...
slider1h = @bind slider1 Slider(1:20, show_value=true);""
...
let
	...
	P(n)=x0->sum(((x-x0)^i)*df/factorial(i) for i in 1:n)
	Pn = P(slider1)(0)
	pnh = L"P(%$(slider1))=\sum_{i=1}^{%$slider1}\frac{f'(0)}{i!}x^i=%$Pn"
	# md"""
	# n = $slider1h
...
manifest_format = "2.0"
project_hash = "f3c009a84c3fa9b697cffc68884e6b951fb4eec0"
